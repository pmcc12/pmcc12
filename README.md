...
<p>I'm currently learning <strong>JavaScript</strong> (and its neverending stack...), and i try always to have a taste of every part of my projects (backend, frontend, databases). Still trying to understand where to fit in, but definitly having more fun in React though.
